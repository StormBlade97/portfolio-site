!(function(e) {
  ...
  function(e, t, i) {
    ...
    function r(e, t) {
      return (
        null == e && (e = 0), null == t && (t = 1), e + Math.random() * (t - e)
      );
    }
    function a(e, t) {
      return (
    ...
    (n.VantaBase = class {
      constructor(e = {}) {
        ...
        if (
          ...
          o('Instance needs "el" param!');
        else if (
          !(
            this.options.el instanceof HTMLElement ||
            ((a = this.el), (this.el = Object(s.e)(a)), this.el)
          )
        )
          return void o("Cannot find element", a);
        for (r = 0; r < this.el.children.length; r++)
          (t = this.el.children[r]),
            ...
            (t.draw = function() {
              t.clear(),
                ...
                (function() {
                  (l -= 0.02), (c += 0.005);
                  if (il < i) il *= 1.1;
                  for (let e = i; e > i - il; e--) {
                    t.beginShape();
                    for (let rc = 0; rc < 360; rc++) {
                      let n = t.radians(rc),
